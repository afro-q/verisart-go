...
const (
	ERROR_GENERATING_UUID ErrorCode = iota + 4	
	USER_ID_IS_INVALID  
	EMAIL_IS_INVALID 
...
const (
	JWT_ERROR_PARSING_THE_PRIVATE_KEY ErrorCode = iota + 9
...
const (
	INVALID_DATABASE_CONFIG ErrorCode = iota + 17
	DATABASE_INIT_ERROR
	DATABASE_NOT_INITIALIZED
)

const (
	DATABASE_ADD_DID_NOT_RETURN_AN_ID ErrorCode = iota + 20
...
const (
	CONFIG_INIT_COULD_NOT_GET_CURRENT_EXE_PATH ErrorCode = iota + 28
...
const (
	ERROR_UNMARSHALING_USER_RECORD_FROM_DATABASE ErrorCode = iota + 33
...
const (
	ERROR_UNMARSHALING_CERTIFICATE_RECORD_FROM_DATABASE ErrorCode = iota + 36
...
const (
	TRANSFER_OBJECT_HAS_NO_CREATED_AT_VALUE	ErrorCode = iota + 40
